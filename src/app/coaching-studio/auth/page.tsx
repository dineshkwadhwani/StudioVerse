      ...
      <div style={{ maxWidth: 1120, margin: "0 auto" }}>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <div>
              <div style={{ fontWeight: 800, color: "#133a56" }}>Coaching Studio</div>
              <div style={{ fontSize: "0.85rem", color: "#4d6e86" }}>Login / Registration</div>
            </div>
          </div>

          <Link href="/coaching-studio" style={{ color: "#1f5c9c", fontWeight: 700, textDecoration: "none" }}>
        ...
        >
          ...
          <p style={{ color: "#4d6e86", marginTop: 8 }}>
            Verify your mobile number, complete your profile, and continue to your Coaching Studio dashboard.
          </p>
          <AuthWizard />
        </section>
      </div>
