...
function mapEvent(id: string, data: DocumentData): EventRecord {
  ...
  return {
    ...
    topicIds: Array.isArray(data.topicIds) ? data.topicIds : undefined,
...
function sanitizePayload(input: EventWriteInput): Record<string, unknown> {
  ...
  const payload: Record<string, unknown> = {
    ...
    subCategoryId: nullToUndef(input.subCategoryId),
    subCategoryName: nullToUndef(input.subCategoryName),
